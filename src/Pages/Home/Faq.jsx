const Faq = () => {
  return (
    <div>
        <p className="text-center text-3xl font-bold underline  ">Have Any questions? </p>
      <div className="flex lg:w-3/4 md:w-4/5 flex-col mx-auto lg:flex-row justify-center items-center">
        ...
        <div className="flex-1 mx-auto">
          <div className="collapse collapse-plus ">
            ...
            <div className="collapse-content">
              <p>
                ...
                teamwork and helps you tackle complex tasks with your study
                group. Simply invite your friends to the assignment, and you can
          ...
          <div className="collapse collapse-plus ">
            <input type="radio" name="my-accordion-3" />
            <div className="collapse-title text-xl font-medium">
              Are there any tools for tracking our study progress and
              performance?
            </div>
            <div className="collapse-content">
              <p>
                Yes, we offer progress-tracking tools. You can monitor your
                study progress, view completed assignments, and assess your
                growth over time. Our platform provides insights into your
                performance, helping you stay on top of your academic goals and
                achievements while studying with friends.
              </p>
            </div>
          </div>
        </div>
